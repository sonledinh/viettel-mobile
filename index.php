						...
						<div class="box-bar">
							...
							<div class="box-filter">
								<ul>
									...
									<li><input type="checkbox" id="2001"><label for="2001">Chương trình giáo dục</label></li>
									<li><input type="checkbox" id="2001"><label for="2001">Giáo án</label></li>
									<li><input type="checkbox" id="2001"><label for="2001">Bài tập</label></li>
									<li><input type="checkbox" id="2001"><label for="2001">Tài liệu bổ trợ khác</label></li>
								</ul>
							</div>
						</div>
						<div class="box-bar">
							...
							<div class="box-filter">
								<ul>
									...
									<li><input type="checkbox" id="3001"><label for="3001">Dưới 50.000đ</label></li>
									<li><input type="checkbox" id="3001"><label for="3001">Từ 50.000đ - 100.000đ</label></li>
									<li><input type="checkbox" id="3001"><label for="3001">Từ 100.000đ - 300.000đ</label></li>
									<li><input type="checkbox" id="3001"><label for="3001">Từ 300.000đ - 500.000đ</label></li>
									<li><input type="checkbox" id="3001"><label for="3001">Từ 500.000đ - 1.000.000đ</label></li>
									<li><input type="checkbox" id="3001"><label for="3001">Trên 1.000.000đ</label></li>
								</ul>
							</div>
						</div>
						<div class="box-bar">
							...
							<div class="box-filter">
								<ul>
									...
									<li><input type="checkbox" id="4001"><label for="4001">Nguyễn Đình Cường</label></li>
									<li><input type="checkbox" id="4001"><label for="4001">Lệ Thị Diệu Thảo</label></li>
									<li><input type="checkbox" id="4001"><label for="4001">Lê Đình Phong</label></li>
									<li><input type="checkbox" id="4001"><label for="4001">Nguyễn Đức Thuận</label></li>
									<li><input type="checkbox" id="4001"><label for="4001">Nguyễn Dũng Chiến</label></li>
									<li><input type="checkbox" id="4001"><label for="4001">Phan Văn Hùng</label></li>
								</ul>
							</div>
						</div>
					</div>
